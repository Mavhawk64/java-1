...
import java.util.*;
/**
 * Write a description of class Fungus here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Fungus implements Disease
{
    City city = new City();
    String u = "";
    String name = "";
    int infect = 1; //Slower, so -=1 after upgrade
    int lethal = 0;
    ...
    //Fungus
    public boolean FungalSpores = false;
    @Override
    public void Done()
    {
    ...
    public void AbilitiesOptions()
    {
        ...
        if(!FungalSpores)
            System.out.println("E. Fungal Spores");
        Scanner sc = new Scanner(System.in);
    ...
    {
        if(nub)
        System.out.println("Fungus: " + name + " " + o + "ed the world! " + name + " is the best disease ever!");
    }
}
