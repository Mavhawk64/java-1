...
import java.util.*;
/**
 * Abstract class Bacteria - write a description of the class here
 * 
 * @author (your name here)
 * @version (version number or date here)
 */
public class Bacteria implements Disease
{
    City city = new City();
    String u = "";
    String name = "";
    ...
    //Bacteria
    public boolean BacterialResilience = false;
    @Override
    public void Done()
    {
    ...
    public void AbilitiesOptions()
    {
        ...
        if(!BacterialResilience)
            System.out.println("E. Bacterial Resillience");
        Scanner sc = new Scanner(System.in);
    ...
    {
        if(nub)
        System.out.println("Bacteria: " + name + " " + o + "ed the world! " + name + " is the best disease ever!");
    }
}
