...
import java.util.*;
/**
 * Write a description of class BioWeapon here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class BioWeapon implements Disease
{
    City city = new City();
    String u = "";
    String name = "";
    ...
    //Bio-Weapon
    public boolean AnnihilateGene = false;
    @Override
    public void Done()
    {
    ...
    public void AbilitiesOptions()
    {
        ...
        if(!AnnihilateGene)
            System.out.println("E. Unlock Annihilate Gene");
        Scanner sc = new Scanner(System.in);
    ...
    {
        if(nub)
        System.out.println("Bio-Weapon: " + name + " " + o + "ed the world! " + name + " is the best disease ever!");
    }
}
