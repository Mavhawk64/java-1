...
import java.util.*;
/**
 * Abstract class Virus - write a description of the class here
 * 
 * @author (your name here)
 * @version (version number or date here)
 */
public class Virus implements Disease
{
    City city = new City();
    String u = "";
    String name = "";
    ...
    //Virus
    public boolean ViralInstability = false;
    @Override
    public void Done()
    {
    ...
    public void AbilitiesOptions()
    {
        ...
        if(!ViralInstability)
            System.out.println("E. Viral Instability");
        Scanner sc = new Scanner(System.in);
    ...
    {
        if(nub)
        System.out.println("Virus: " + name + " " + o + "ed the world! " + name + " is the best disease ever!");
    }
}
