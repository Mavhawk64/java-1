 ...
 */
public class Parasite implements Disease
{
    City city = new City();
    String u = "";
    String name = "";
    ...
    //Parasite
    public boolean Symbiosis = false; //if true, change rand to lower number
    @Override
    public void Done()
    {
    ...
    public void AbilitiesOptions()
    {
        ...
        if(!Symbiosis)
            System.out.println("E. Symbiosis");
        Scanner sc = new Scanner(System.in);
    ...
    {
        if(nub)
        System.out.println("Parasite: " + name + " " + o + "ed the world! " + name + " is the best disease ever!");
    }
}
