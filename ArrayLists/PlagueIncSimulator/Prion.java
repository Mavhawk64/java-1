...
import java.util.*;
/**
 * Write a description of class Prion here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Prion implements Disease
{
    City city = new City();
    String u = "";
    String name = "";
    ...
    //Prion
    public boolean NeuralAtrophy = false;
    @Override
    public void Done()
    {
    ...
    public void AbilitiesOptions()
    {
        ...
        if(!NeuralAtrophy)
            System.out.println("E. Neural Atrophy");
        Scanner sc = new Scanner(System.in);
    ...
    {
        if(nub)
        System.out.println("Prion: " + name + " " + o + "ed the world! " + name + " is the best disease ever!");
    }
}
