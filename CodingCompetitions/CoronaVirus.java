...
public class CoronaVirus
{
    ...
    {
        BigInteger pop = new BigInteger("382200000");
        BigInteger d = new BigInteger("1834933472251084800000");
        BigDecimal x = new BigDecimal(d.multiply(pop));
        System.out.println(d.multiply(pop)); //701311573094364610560000000000
        int scale = 50;
        BigDecimal n = ln(x,scale);
        BigDecimal e = ((new BigDecimal("2")).multiply( ln(new BigDecimal("720"), scale))).add(ln(new BigDecimal("7"), scale));
        System.out.println(n.divide(e, new MathContext(50)));
    }
