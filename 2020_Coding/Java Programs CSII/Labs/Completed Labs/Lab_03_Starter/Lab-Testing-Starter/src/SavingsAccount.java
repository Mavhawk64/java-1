...
// TERM: Fall 2020
// 
// NAME: Dr. Dorn, Mr. Cavanaugh, and Maverick Berkland
 ...
 * 
 * @author bdorn, pcavanaugh, mberkland
 *
 */
public class SavingsAccount 
{
	...
	{
		if (lastNameIn != null && !lastNameIn.isEmpty())
		{
			lastName = lastNameIn;
		}
	}
	...
	{
		final int MOS_PER_YEAR = 12;
		balance += balance * annualInterestRate / MOS_PER_YEAR;
	}
